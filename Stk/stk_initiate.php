...
if(isset($_POST['submit'])){
  ...
  # access token
  $consumerKey = 'j0A054W0HGRu2cMAgmrInQHH0s1GbSVp'; //Fill with your app Consumer Key
  $consumerSecret = 'QR6Zac1lXYCmspBy'; // Fill with your app Secret
  ...
  */
  ...
  $message = "
    ...
    <span><strong>Paid Cash: </strong>$Amount</span>
  ";
  ...
  try {
      ...
      $mail->Subject = 'MBUGUA HOUSING PROPERTY';
      $mail->Body    = $message;
  ...
  ?><script>alert("Payment done successfully")</script>
