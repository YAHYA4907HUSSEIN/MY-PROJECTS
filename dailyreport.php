...
//Sugar Available in stock after production
...
$sqlSugarused  = "SELECT godownstkkg  FROM production where date = '$dt' ";
...
// Caluclation of sales
		$sql3  = "SELECT *  FROM  billing INNER JOIN sales ON sales.billingid = billing.billingid  WHERE (billing.date = '$dt')";
...
// Caluclation of salary - Paid
	$sql  = "SELECT *  FROM salary WHERE status='Paid'  AND (date = '$dt')";
	$qsql = mysqli_query($connection,$sql);
...
$sql  = "SELECT *  FROM salary WHERE status='Pending'  AND (date = '$dt')";
$qsql = mysqli_query($connection,$sql);
while($rs = mysqli_fetch_array($qsql))
{
	$sql1  = "SELECT * FROM employee WHERE empid=$rs[empid]";
...
$sql ="SELECT SUM(expenseamt) FROM  expenses where status='Pending'  AND (date = '$dt')"; 
$qsql = mysqli_query($connection,$sql);
$rs = mysqli_fetch_array($qsql);
...
<form method="get" action="" name="report" onsubmit="return validatereport(dailyreport.value)">
<table width="878" border="1" class="tftable">
  <tr>
    <th width="137" scope="row">&nbsp;Select Date :</th>
    <td width="461">&nbsp; &nbsp;  <input type="date" name="dailyreport" value="<?php echo $_GET[dailyreport]; ?>" max="<?php echo date("Y-m-d");?>" 
...
<tr>
  <th height="29" colspan="4" scope="col">Sugar Purchased in Kg</th>
  <th colspan="2" scope="col"><?php echo $totqty + 0 ?></th>
</tr>
<tr>
  <th height="29" colspan="4" scope="col">Sugar Used For Production in Kg</th>
  <th colspan="2" scope="col"><?php echo $Sugarused + 0 ?></th>
</tr>
<tr>
  <th height="29" colspan="4" scope="col">Sugar Available In Stock After Production in Kg</th>
...
<?php  
 $sql2  = " SELECT     SUM(sales.qty) AS Expr1, product.productname,product.qtytype
FROM         product INNER JOIN
                      sales ON product.productid = sales.productid INNER JOIN
                      billing ON sales.billingid = billing.billingid
WHERE     (billing.date = '$dt') GROUP BY product.productid, product.productname";
$qsql2 = mysqli_query($connection,$sql2);
if(mysqli_num_rows($qsql2) == 0)
{
	echo "<center>None</center>";
...
<tr>
  <th width="114" scope="col">Sales Amount <font style='color:red'>+</font></th>
  <th width="140" height="29" scope="col">Purchase Amount <strong><font style='color:red'>-</font></strong></th>
  <th width="164" scope="col">Paid Expense Amount <strong><font style='color:red'>-</font></strong></th>
  <th width="149" scope="col">Paid Salary Amount <strong><font style='color:red'>-</font></strong></th>
  <th width="132" scope="col">Pending Expense Amount <strong><font style='color:red'>-</font></strong></th>
  <th width="139" scope="col">Pending Salary Amount <strong><font style='color:red'>-</font></strong></th>
</tr>
<tr>    
<div align="center">
...
<tr>
  ...
  <th scope="col">&nbsp; Ksh.
  <?php $profittotal = $grandtotal1 +  $grandtotal; 
  echo ceil($profittotal);?>
  </th>
</tr>
  <tr>
    <th height="30" colspan="7" align="right" scope="col"><div align="left">Profit In Words :- Kenyan shilling 
      <?php
  function no_to_words($no)
{   
              $words = array('0'=> '' ,'1'=> 'one' ,'2'=> 'two' ,'3' => 'three','4' => 'four','5' => 'five','6' => 'six','7' => 'seven','8' => 'eight','9' => 'nine','10' => 'ten','11' => 'eleven','12' => 'twelve','13' => 'thirteen','14' => 'fouteen','15' => 'fifteen','16' => 'sixteen','17' => 'seventeen','18' => 'eighteen','19' => 'nineteen','20' => 'twenty','30' => 'thirty','40' => 'fourty','50' => 'fifty','60' => 'sixty','70' => 'seventy','80' => 'eighty','90' => 'ninty','100' => 'hundred ','1000' => 'thousand','100000' => 'One hundred','200000' => 'Two hundred','1000000' => 'One million');
    if($no == 0)
        return ' ';
    else {
	$novalue='';
...
disp_setting+="scrollbars=yes,width=650, height=600, left=100, top=25";
   ...
   docprint.document.write('a{color:#000;text-decoration:none;} </style>');
    docprint.document.write('</head><body onLoad="self.print()"><center><h2>Kitere Sugar Company</h2><p>Near Rongo University.</p><p>Mob. : 0724126885 <strong>Email: abdi@gmail.com</strong></p><h2 align="center">Daily Report</h2>');
...
function validatereport(dailyreport)
{
	if(document.report.dailyreport.value == "")
	{
		alert("Date should not be empty..");
		document.report.dailyreport.focus();
		return false;
	}
	else
	{
