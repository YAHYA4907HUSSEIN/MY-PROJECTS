...
?>
	<div id="page-wrapper" style= "background-color: yellow">>
		<div class="row">
<?php
?>
					      ...
					      <form method="post" action="" enctype="multipart/form-data">
                            <div align="center">
                              <table width="537" height="444" border="1" class="tftable">
							    ...
							    <tr>
							    <th height="33" scope="row"> Grand total </th>	
							    <td>&nbsp;
                                  <?php 
									$qsql = mysqli_query($connection,$sql);
									$rs = mysqli_fetch_array($qsql);
									$grandtotal =($totalsales + $totaltaxamt1)-($total=$rs[0]*1+$grandtot = $grandtot + $totamt;)
									echo "Ksh. $total";
								  ?>
							      </td>
							    </tr>
